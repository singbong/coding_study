...
N마리 폰켓몬의 종류 번호가 담긴 배열 nums가 매개변수로 주어질 때, N/2마리의 폰켓몬을 선택하는 방법 중, 가장 많은 종류의 
폰켓몬을 선택하는 방법을 찾아, 그때의 폰켓몬 종류 번호의 개수를 return 하도록 solution 함수를 완성해주세요.
...
힌트: 구현 방법
우선 nums 배열에서 중복을 제거하여 폰켓몬 종류의 개수를 구합니다. 이를 위해 Set 자료형을 사용할 수 있습니다. 
그 다음, 선택할 수 있는 폰켓몬의 수인 N/2와 폰켓몬 종류의 개수 중 작은 값을 반환하면 됩니다.
"""
def solution(nums):
    # 중복을 제거한 폰켓몬의 종류 수
